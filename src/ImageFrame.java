...
public class ImageFrame extends JFrame implements ActionListener, ChangeListener, MouseMotionListener, MouseListener {
	...
	public ImageFrame(String title) {
		...
		theDesktop.setBackground(new Color(30, 144, 255));
		getContentPane().add(theDesktop); // add desktop pane to frame
		
		panel = new JPanel();
		panel.setBorder(new TitledBorder(null, "JPanel title", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		panel.setBounds(0, -18, 337, 58);
		theDesktop.add(panel);
		panel.setLayout(null);
		
		JSlider slider = new JSlider();
		slider.setBounds(45, 25, 200, 26);
		panel.add(slider);
		
		JButton button = new JButton("-");
		button.setBounds(6, 25, 39, 26);
		panel.add(button);
		button.setBackground(Color.LIGHT_GRAY);
		
		JButton button_1 = new JButton("+");
		button_1.setBounds(245, 25, 43, 26);
		panel.add(button_1);
		button_1.setForeground(new Color(0, 0, 0));
		button_1.setBackground(Color.LIGHT_GRAY);
		
		textField = new JTextField();
		textField.setBounds(288, 25, 43, 26);
		panel.add(textField);
		...
		menuImageFrame = new JMenu("ImageFrame");
		menuItemAbout = new JMenuItem("About");
		menuItemAbout.addActionListener(this);
		menuImageFrame.add(menuItemAbout);
	...
	private void imageFileChooser() {
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
			...
			try {
				...
				frameOriginal.getContentPane().add(imagePanelOriginal, BorderLayout.CENTER);
				frameOriginal.pack();
				...
				frameProcessed.getContentPane().add(imagePanelProcessed, BorderLayout.CENTER);
				frameProcessed.pack();
